...
import StokWarung from "../public/assets/StokWarung.png"
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-8'>
          ...
          <div className='text-center md:text-left'>
            <div className='inline-flex items-center gap-2 mb-4'>
              <Image src={StokWarung} alt="Logo" className='w-[50px]' />
            ...
            <p className='text-gray-600 dark:text-gray-400 leading-relaxed max-w-sm'>
              Kelola stok gudang Anda dengan lebih efisien dan akurat menggunakan aplikasi kami! Dilengkapi dengan fitur real-time tracking, laporan otomatis, dan antarmuka yang mudah digunakan, kami memastikan pengelolaan inventaris menjadi lebih praktis, sehingga Anda bisa fokus pada perkembangan bisnis tanpa khawatir tentang stok yang terlewat.
            </p>
          </div>
        ...
        <div className='flex flex-col md:flex-row justify-between items-center'>
          <div className='text-center md:text-left mb-4 md:mb-0'>
            <p className='text-gray-500 dark:text-gray-400 text-sm'>
              © {new Date().getFullYear()} Stok Warung. All rights
              reserved.
            </p>
          </div>
